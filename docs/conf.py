...
breathe_default_project = "easyfs"
breathe_projects = {
    'easyfs': doxygen_out_xml
}
...
project = u'easyfs'
copyright = u'2021 - Pierre Delaunay'
...
latex_documents = [
  (master_doc, 'easyfs.tex', u'easyfs Documentation',
...
man_pages = [
    (master_doc, 'easyfs', u'easyfs Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'easyfs', u'easyfs Documentation',
   author, 'easyfs', 'Simple Filesystem',
   'Miscellaneous'),
]
